...
function nextthree(){
    ...
    document.getElementById("introcoverbg").style.display ="block";
    document.getElementById("introcoverbg").style.zIndex ="100000";
    document.getElementById("experienceintropopup").style.display ="block";
    document.getElementById("bodyintro").style.backgroundImage ="none";
...
function nextoneid(){
    document.getElementById("introtexts").innerHTML = "Studi telah membuktikan bahwa daging ikan yang dikonsumsi massal dari sungai Indonesia mengandung mikroplastik.";
    document.getElementById("next1").style.display ="none";
    document.getElementById("next2").style.display ="block";
    document.getElementById("prev2").style.display ="block";
}
function nexttwoid(){
    document.getElementById("introtexts").innerHTML = "Karena mikroplastik mengandung polimer dan zat kimia berbahaya, ikan yang terkontaminasi dapat membahayakan kesehatan manusia ketika termakan.";
    document.getElementById("next1").style.display ="none";
    document.getElementById("next2").style.display ="none";
    document.getElementById("prev2").style.display ="none";
    document.getElementById("prev3").style.display ="block";
